...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Scrap Mechanic Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our Steam game resource platform. Your privacy matters to us.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              ...
              with Valve Corporation (Steam) or the developers of Scrap Mechanic. All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@scrapmechanic.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@scrapmechanic.wiki</a>
            </p>
            <p>
