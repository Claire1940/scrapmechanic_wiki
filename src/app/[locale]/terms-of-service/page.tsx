...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description: "Read the Terms of Service for Scrap Mechanic Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Steam game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              ...
              and resources related to the Steam game "Scrap Mechanic". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Game guides and survival strategies</li>
              <li>Vehicle and machine build blueprints</li>
              <li>Crafting recipes and component kit guides</li>
              <li>Farmbot and enemy combat guides</li>
              <li>Survival map and location walkthroughs</li>
            ...
            <p>
              ...
              Valve Corporation (Steam) or the official developers of Scrap Mechanic. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              trademarks, are the property of Valve Corporation (Steam) and/or the developers of Scrap Mechanic. We use such
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, SCRAP MECHANIC WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@scrapmechanic.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@scrapmechanic.wiki</a>
            </p>
            <p>
