        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <ul>
              ...
              <li><strong>Axolot Games</strong> - Developer and publisher of Scrap Mechanic</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Scrap Mechanic</strong> - Trademark of Axolot Games</li>
            ...
            <p>
              ...
              Email: <a href="mailto:dmca@scrapmechanic.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@scrapmechanic.wiki</a>
            </p>
            <p>
            ...
            <p>
              Example attribution: <em>"Source: Scrap Mechanic Wiki (scrapmechanic.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@scrapmechanic.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@scrapmechanic.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@scrapmechanic.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@scrapmechanic.wiki</a>
            </p>
            <p>
