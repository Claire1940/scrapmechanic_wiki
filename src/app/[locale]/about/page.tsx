...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.scrapmechanic.wiki'
  const path = '/about'

  return {
    title: 'About Scrap Mechanic Wiki - Your Ultimate Steam Game Resource',
    description: 'Learn about Scrap Mechanic Wiki, a community-driven resource hub providing comprehensive guides, crafting tips, creature info, and strategies for the Scrap Mechanic Steam game.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              ...
              master the Steam game "Scrap Mechanic". We are a community-driven platform that provides comprehensive guides,
              vehicle builds, crafting recipes, survival walkthroughs, and Farmbot combat tips to enhance your gaming experience.
            </p>
            <p>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              ...
              vehicle build blueprints, crafting recipes, or advanced survival and farming tactics.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              ...
              <p className="text-slate-300">
                Comprehensive crafting recipes, component kits, and workbot guides to help you
                refine resources and build the parts you need to survive.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              <div className="text-2xl mb-3">🚜</div>
              <h3 className="text-xl font-semibold text-white mb-2">Vehicle &amp; Machine Builds</h3>
              <p className="text-slate-300">
                Step-by-step blueprints for cars, drills, aircraft, and transport vehicles, plus
                automated machines powered by the physics engine.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              <div className="text-2xl mb-3">🤖</div>
              <h3 className="text-xl font-semibold text-white mb-2">Enemy &amp; Farmbot Guides</h3>
              <p className="text-slate-300">
                Spawn locations, attack patterns, weaknesses, and drops for Farmbots, Tapebots,
                and other threats on the farming planet.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">Survival Map &amp; Locations</h3>
              <p className="text-slate-300">
                Detailed guides to the crashed ship, mechanic stations, traders, warehouses, and
                packing stations across the survival map.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              <div className="text-2xl mb-3">🌾</div>
              <h3 className="text-xl font-semibold text-white mb-2">Farming &amp; Defense</h3>
              <p className="text-slate-300">
                Crop farming, watering setups, raid levels, and base defense strategies to protect
                your harvest from incoming waves.
              </p>
            </div>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              <strong>Want to contribute?</strong> Whether you've discovered a new crafting recipe, built a clever vehicle,
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p className="text-slate-400 italic text-sm">
              Project Codename: "Drilling Thunder" – Building, surviving, and thriving on the farming planet.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <div className="not-prose grid md:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                ...
                <a href="mailto:contact@scrapmechanic.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contact@scrapmechanic.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Bug Reports</h3>
                <a href="mailto:support@scrapmechanic.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  support@scrapmechanic.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Content Submissions</h3>
                <a href="mailto:contribute@scrapmechanic.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contribute@scrapmechanic.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Partnerships</h3>
                <a href="mailto:partnerships@scrapmechanic.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  partnerships@scrapmechanic.wiki
                </a>
              </div>
            </div>
